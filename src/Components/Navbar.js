...
const Navbar = () => {
  ...
  <div class="container-fluid">
    <a class="navbar-brand" style={{width:"330px",display:"inline-flex"}} href="/"><img style={{paddingTop:"2px"}} className='logo' src="https://assets-marketing-site.calendly.com/icons/icon-384x384.png?v=562a6280871383fd65846bc6297cf964" alt="Calendly" /> <h1 style={{color:"rgb(26, 145, 243)",fontSize:"30px",padding:"5px"}}>Calendly</h1></a>
